...
const users = [
  { id: 1, name: "Harsh", posts: 100 },
  { id: 2, name: "Uday", posts: 15 },
  { id: 3, name: "Harshad", posts: 40 },
  { id: 4, name: "Vikram", posts: 30 },
  { id: 5, name: "Bansal", posts: 5 },
  { id: 6, name: "Anshul", posts: 18 },
];

const posts = [
  { id: 1, title: "First Post", comments: 1, createdAt: new Date("2024-03-10") },
  { id: 2, title: "Second Post", comments: 2, createdAt: new Date("2024-03-11") },
  { id: 3, title: "Third Post", comments: 3, createdAt: new Date("2024-03-12") },
  { id: 4, title: "Fourth Post", comments: 4, createdAt: new Date("2024-03-13") },
  { id: 5, title: "Fifth Post", comments: 5, createdAt: new Date("2024-03-14") },
];
